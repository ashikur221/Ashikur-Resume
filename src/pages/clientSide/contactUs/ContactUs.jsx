...
const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_w43l46m', 'template_l5ha3qv', formRef.current, {
        publicKey: 'Ouigr6Yh1J8NjkpWX',
      })
      .then(
        () => {
  ...
  return (
    <div className=' mt-4'>
      ...
      <Helmet>
        <title>Ashikur Portfolio | Contact Me</title>
      </Helmet>
              ...
              <div className="lg:w-1/2 md:w-2/3 mx-auto">
                <form action="" onSubmit={sendEmail}
                  ...
                  <div className="flex flex-wrap -m-2">
                    ...
                    <div className="p-2 w-full">
                      <button className="flex mx-auto text-white bg-theme_orange border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Connect</button>
                    </div>
                    <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                      <a className="text-white">ashikur1602@email.com</a>
                      <p className="leading-normal my-5">13 No. Road DIT Project, Merul Badda
                        <br />Dhaka, Bangladesh
                      </p>
